...
_OPRATORLATENCY = _descriptor.Descriptor(
  name='OpratorLatency',
  full_name='mace.OpratorLatency',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='CPU_latency', full_name='mace.OpratorLatency.CPU_latency', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='GPU_latency', full_name='mace.OpratorLatency.GPU_latency', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='Transpose_latency_NCHW_to_NHWC', full_name='mace.OpratorLatency.Transpose_latency_NCHW_to_NHWC', index=2,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='Transpose_latency_NHWC_to_NCHW', full_name='mace.OpratorLatency.Transpose_latency_NHWC_to_NCHW', index=3,
      number=4, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_OPERATORDEF = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ready', full_name='mace.OperatorDef.ready', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='node_id', full_name='mace.OperatorDef.node_id', index=11,
      number=100, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='op_id', full_name='mace.OperatorDef.op_id', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='padding', full_name='mace.OperatorDef.padding', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='node_input', full_name='mace.OperatorDef.node_input', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='out_max_byte_size', full_name='mace.OperatorDef.out_max_byte_size', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='operatorLatency', full_name='mace.OperatorDef.operatorLatency', index=16,
...
_NETDEF = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='input_info', full_name='mace.NetDef.input_info', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='output_info', full_name='mace.NetDef.output_info', index=4,
...
_OPERATORDEF.fields_by_name['operatorLatency'].message_type = _OPRATORLATENCY
...
DESCRIPTOR.message_types_by_name['OpratorLatency'] = _OPRATORLATENCY
...
ConstTensor = _reflection.GeneratedProtocolMessageType('ConstTensor', (_message.Message,), {
...
QuantizeActivationInfo = _reflection.GeneratedProtocolMessageType('QuantizeActivationInfo', (_message.Message,), {
...
OpratorLatency = _reflection.GeneratedProtocolMessageType('OpratorLatency', (_message.Message,), {
  'DESCRIPTOR' : _OPRATORLATENCY,
  '__module__' : 'mace_pb2'
  # @@protoc_insertion_point(class_scope:mace.OpratorLatency)
  })
_sym_db.RegisterMessage(OpratorLatency)
...
InputOutputInfo = _reflection.GeneratedProtocolMessageType('InputOutputInfo', (_message.Message,), {
