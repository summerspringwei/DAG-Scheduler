...
_OPERATORDEF = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='opratorLatency', full_name='mace.OperatorDef.opratorLatency', index=16,
...
_OPERATORDEF.fields_by_name['opratorLatency'].message_type = _OPRATORLATENCY
